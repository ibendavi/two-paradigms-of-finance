...
ACADEMIC_STYLE = [
    ...
    ("this course", r"(?:this|the|a|an|introductory|advanced|graduate|undergraduate)\s+courses?\b"),
    ("course materials", r"course\s+(?:materials?|outline|descriptions?|requirements?|objectives?)"),
